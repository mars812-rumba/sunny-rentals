...
export const messages = {
  ru: {
    ...
    trust: {
      ...
      intro:
        "Сайт помогает выбрать модель, Telegram подтверждает клиента, а менеджер получает все детали бронирования.",
      benefits: [
        ...
        ["Связь в Telegram", "Профиль подтверждается через Telegram, а заявка сразу передаётся менеджеру."],
      ],
  ...
  en: {
    ...
    trust: {
      ...
      intro:
        "The website helps you choose a model, Telegram verifies your profile, and the manager receives all booking details.",
      benefits: [
        ...
        ["Telegram support", "Verify your profile in Telegram and send the request straight to a manager."],
      ],
