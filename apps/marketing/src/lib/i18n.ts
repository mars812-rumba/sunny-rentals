...
export const messages = {
  ru: {
    ...
    hero: {
      ...
      title: "Конкретная машина. Понятная стоимость.",
      ...
      realPhotosProof: "Реальные авто в каталоге",
      carouselAria: "Реальные авто и байки из разных категорий",
      showVehicle: "Показать транспорт",
    ...
    booking: {
      ...
      timeOrder: "Дата и время возврата должны быть позже получения.",
      note: "Заявка будет передана менеджеру только после вашего подтверждения в WebApp.",
      categories: ["Компакт", "Седан", "SUV", "7+ мест", "Байк"],
      locations: ["Аэропорт · 0 ฿", "Отель/город · 500 ฿", "Вилла/город · 500 ฿"],
    },
    fleet: {
    ...
    catalog: {
      ...
      anyPrice: "Любая цена",
      upTo: "до",
      childSeat: "Бесплатное детское кресло",
      deliveryZone: "Доставка",
      anyDelivery: "Любая зона",
      airportDelivery: "Аэропорт · 0 ฿",
      cityDelivery: "Город · 500 ฿",
      reset: "Сбросить",
      filterNote: "Цена без выбранных дат сравнивается с минимальной ставкой. Доставка в аэропорт бесплатна, по городу — 500 ฿. После выбора периода карточки покажут точную стоимость аренды; доступность подтвердит менеджер.",
    ...
    trust: {
      ...
      intro:
        "Выбранная машина и детали заявки передаются в Telegram — не нужно заполнять всё заново.",
      benefits: [
        ...
        ["Условия без догадок", "Стоимость доставки известна заранее, а доступность конкретной машины подтверждает менеджер."],
        ["Связь в Telegram", "Выбранная машина сохраняется при переходе — останется подтвердить даты и место выдачи."],
      ],
      priceEyebrow: "Из чего складывается сумма",
      priceTitle: "Ставка сразу, полный расчёт — по датам",
      priceIntro: "В карточке видна минимальная ставка за сутки. После выбора дат показываем стоимость аренды, а депозит и доставку — отдельно.",
      priceParts: [
        ...
        ["Доставка", "Аэропорт — бесплатно. Доставка по городу, к отелю или вилле — 500 ฿."],
      ...
      contactIntro: "Telegram-бот ведёт в бронирование, а @marseloid отвечает на вопросы по условиям, документам и доставке.",
      ...
      questions: [
        ...
        ["Можно получить машину в аэропорту?", "Да. Доставка в аэропорт бесплатна. Доставка по городу, к отелю или вилле стоит 500 ฿."],
        ...
        ["Когда заявка передаётся менеджеру?", "После авторизации Telegram сохраняет выбранную модель. Полноценная заявка создаётся после подтверждения дат, доставки и автомобиля в WebApp."],
      ],
    },
    contact: {
      title: "Бронь и связь",
    ...
    vehicle: {
      ...
      delivery:
        "Доставка в аэропорт бесплатна, по городу, к отелю или вилле — 500 ฿. Доступность конкретной машины подтвердит менеджер после выбора дат.",
      realPhotos: "Фото реальной машины",
      realPhotosValue: "Реальные фотографии конкретного транспорта",
      termsEyebrow: "Условия этой модели",
      termsTitle: "До бронирования — без мелкого шрифта",
      termsIntro: "Цена аренды, депозит, страховка и доставка показаны отдельно. Неподтверждённые условия не добавляем.",
      depositNote: "Депозит не входит в стоимость аренды и указывается отдельной суммой.",
      insurance: "Страховка",
      insuranceClass: "Класс 1",
      insuranceExcess: "Франшиза",
      noInsuranceShort: "Без страховки",
      noInsurance: "На байки страховка не предоставляется.",
      deliveryTitle: "Доставка",
      airport: "Аэропорт",
      city: "Город / отель / вилла",
      handoverTitle: "При получении",
      fullTank: "Полный бак",
      cleanVehicle: "Автомобиль передаётся чистым.",
      childSeat: "Детское кресло",
      childSeatFree: "Бесплатно · 0 ฿",
      childSeatNote: "Добавим по запросу при подтверждении бронирования.",
      faqEyebrow: "По этой машине",
      faqTitle: "Ответы до бронирования",
      faqIntro: "Условия относятся к выбранной модели. Фактическую доступность на даты подтверждает менеджер.",
  ...
  en: {
    ...
    hero: {
      ...
      title: "A specific vehicle. A clear cost.",
      ...
      realPhotosProof: "Real vehicles in the catalogue",
      carouselAria: "Real cars and scooters from different categories",
    ...
    booking: {
      ...
      timeOrder: "Return date and time must be later than pick-up.",
      note: "Your request is sent to a manager after you confirm it in the WebApp.",
      categories: ["Compact", "Sedan", "SUV", "7+ seats", "Scooter"],
      locations: ["Airport · 0 ฿", "Hotel/city · 500 ฿", "Villa/city · 500 ฿"],
    },
    fleet: {
    ...
    catalog: {
      ...
      anyPrice: "Any price",
      upTo: "up to",
      childSeat: "Free child seat",
      deliveryZone: "Delivery",
      anyDelivery: "Any zone",
      airportDelivery: "Airport · 0 ฿",
      cityDelivery: "City · 500 ฿",
      reset: "Reset",
      filterNote: "Without dates, price uses the lowest rate. Airport delivery is free; city delivery is 500 ฿. Select a period to see the exact rental total; a manager confirms availability.",
    ...
    trust: {
      ...
      intro:
        "Your selected vehicle and request details carry over to Telegram, so you do not have to enter everything again.",
      benefits: [
        ...
        ["No guessed terms", "Delivery prices are clear upfront, while a manager confirms the specific vehicle's availability."],
        ["Telegram support", "Your selected vehicle is saved when you continue; just confirm the dates and pick-up point."],
      ],
      priceEyebrow: "What makes up the total",
      priceTitle: "See the rate now, calculate the total by date",
      priceIntro: "Each card shows the lowest daily rate. Select dates to calculate the rental cost, with deposit and delivery shown separately.",
      priceParts: [
        ...
        ["Delivery", "Airport delivery is free. City, hotel or villa delivery is 500 ฿."],
      ...
      contactIntro: "The Telegram bot handles booking, while @marseloid answers questions about terms, documents or delivery.",
      ...
      questions: [
        ...
        ["Can I collect the car at the airport?", "Yes. Airport delivery is free. City, hotel or villa delivery costs 500 ฿."],
        ...
        ["When is my request sent to a manager?", "Telegram saves your selected model after verification. The full request is created after you confirm the dates, delivery and vehicle in the WebApp."],
      ],
    },
    contact: {
    ...
    vehicle: {
      ...
      delivery:
        "Airport delivery is free; city, hotel or villa delivery is 500 ฿. A manager confirms vehicle availability after you choose your dates.",
      realPhotos: "Real vehicle photos",
      realPhotosValue: "Real photos of the specific vehicle",
      termsEyebrow: "Terms for this model",
      termsTitle: "Everything clear before you book",
      termsIntro: "Rental price, deposit, insurance and delivery are shown separately. Unverified terms are not added.",
      depositNote: "The deposit is separate and is not included in the rental price.",
      insurance: "Insurance",
      insuranceClass: "Class 1",
      insuranceExcess: "Excess",
      noInsuranceShort: "No insurance",
      noInsurance: "Scooters are supplied without insurance.",
      deliveryTitle: "Delivery",
      airport: "Airport",
      city: "City / hotel / villa",
      handoverTitle: "At handover",
      fullTank: "Full tank",
      cleanVehicle: "The car is supplied clean.",
      childSeat: "Child seat",
      childSeatFree: "Free · 0 ฿",
      childSeatNote: "Request it when confirming your booking.",
      faqEyebrow: "About this vehicle",
      faqTitle: "Answers before you book",
      faqIntro: "These terms apply to the selected model. A manager confirms availability for your dates.",
